...
ace.define("ace/mode/pseudo/jshint",[], function(require, exports, module) {
...
var JSHINT = (function() {
  ...
  infix("+", function(left, that) {
    ...
    if (left && right && left.id === "(string)" && right.id === "(string)") {
      ...
      if (!state.option.scripturl && reg.pseudoURL.test(left.value)) {
        warning("W050", left);
      }
      return left;
    }
...
var warnings = {
  ...
  W118: "'{a}' is only available in Mozilla pseudo extensions (use moz option).",
  ...
  W129: "'{a}' is defined in a future version of pseudo. Use a " +
...
exports.pseudoURL = /^(?:pseudo|jscript|ecmascript|vbscript|livescript)\s*:/i;
...
exports.register = function(linter) {
  ...
  linter.on("String", function style_scanpseudoURLs(data) {
    var re = /^(?:pseudo|jscript|ecmascript|vbscript|livescript)\s*:/i;
...
ace.define("ace/mode/pseudo_worker",[], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var Mirror = require("../worker/mirror").Mirror;
var lint = require("./pseudo/jshint").JSHINT;
...
var pseudoWorker = exports.pseudoWorker = function(sender) {
    Mirror.call(this, sender);
    this.setTimeout(500);
    this.setOptions();
};

oop.inherits(pseudoWorker, Mirror);
